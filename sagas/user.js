...
function* watchFollow() {
  yield takeEvery(FOLLOW_REQUEST, follow); //LOG_IN이라는 액션이 실행될때까지 기다린다. 실행되면 logIn실행
}
function* watchUnfollow() {
  yield takeEvery(UNFOLLOW_REQUEST, unfollow); //LOG_IN이라는 액션이 실행될때까지 기다린다. 실행되면 logIn실행
}
function* watchLogin() {
